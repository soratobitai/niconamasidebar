...
よく見る配信者ほど上に出す。**点数制**（開いた時+1／視聴5分ごと+1・1回の視聴で最大+5）。
...
## ✅ CN. 「人気順の基準」の目盛りを校正した（2026-08-10・1日で2度）

利用者が他サイトの推定同接と実機で比較して判明。

```
旧   [3, 5, 8, 10, 14, 20, 30, 45]      既定10  … 全体に短すぎた
中間 [10, 17, 27, 40, 58, 80, 110, 150] 既定40  … 今度は幅が広すぎた
最終 [11, 13, 15, 17, 19, 22, 25, 29]   既定17  … 17分が正解。刻みを細かく
```
