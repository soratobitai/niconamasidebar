...
// 🔴 **2026-08-10 に2度校正した。** 最終形がこれ。
//    経緯: 旧 [3,5,8,10,14,20,30,45]（既定10）は全体に短すぎ、他サイトと比べて長い配信が
//    少なく出ていた。→ [10,17,27,40,58,80,110,150]（既定40）へ広げたが、今度は**幅が広すぎ**、
//    利用者の実機比較では**左から2番目(17分)が一番近い**という結果になった。
//    そこで **17分を真ん中に、刻みを細かく**した。ここは「合わせ込み」の目盛りであって、
//    大きく動かすものではない。
// ⚠️ 等間隔にしないという以前の方針は、幅が狭くなったので実質意味が無くなった。
//    比が 1.15 前後の緩やかな等比にしてある。
export const dwellMinutesScale = [11, 13, 15, 17, 19, 22, 25, 29];
